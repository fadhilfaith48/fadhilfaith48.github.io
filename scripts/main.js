...
const dataKarya = [
    ...
    { id: 3, judul: "Aplikasi Kalkulator Sederhana", siswa: "Andi Wijaya", kelas: "XII IPA 1", kategori: "Informatika", tipe: "image", file: "https://via.placeholder.com/400x200?text=Karya+Informatika", thumbnail: "https://via.placeholder.com/400x200?text=Karya+Informatika", likes: 30, deskripsi: "Dibuat menggunakan HTML, CSS, dan JavaScript murni. Memiliki fungsi penambahan, pengurangan, perkalian, dan pembagian." },
    { id: 4, judul: "Lukisan Abstrak 'Kehidupan Kota'", siswa: "Citra Dewi", kelas: "X Bahasa 3", kategori: "Seni Rupa", tipe: "image", file: "https://via.placeholder.com/400x200?text=Karya+Seni", thumbnail: "https://via.placeholder.com/400x200?text=Karya+Seni", likes: 105, deskripsi: "Menggunakan cat akrilik dengan teknik palet pisau untuk menampilkan dinamika dan hiruk pikuk kehidupan urban." },
    { id: 5, judul: "Makalah Sejarah Kerajaan Majapahit", siswa: "Budi Santoso", kelas: "XI IPS 2", kategori: "Sejarah", tipe: "pdf", file: "assets/uploads/Sejarah Kerajaan Majapahit yang merupakan salah satu kerajaan terbesar dalam sejarah Nusantara.pdf", thumbnail: "https://via.placeholder.com/400x200/33FF57/FFFFFF?text=Dokumen+PDF+2", likes: 21, deskripsi: "Penelitian komprehensif tentang struktur pemerintahan dan pengaruh Majapahit di Asia Tenggara." },
